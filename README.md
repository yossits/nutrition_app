...
**סטטוס:** אפיון סגור · ליבה מוכחת על מאגר הזרע (ספייק, 27.08.2026) · שער היציאה מהשלב (#42): [`docs/spec/05-food-db.md`](docs/spec/05-food-db.md) §8 · שלב נוכחי: ייבוא מאגר משרד הבריאות
